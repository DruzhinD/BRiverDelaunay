...
namespace DelaunatorSharp
{
    public class Delaunator
    {
        ...
        /// Одно значение на половину ребра, содержащее противоположную половину 
        /// ребра в соседнем треугольнике, или -1, если смежного треугольника нет
        /// </summary>
        public int[] Halfedges { get; private set; }
        /// <summary>
        /// The initial points Delaunator was constructed with.
        /// Исходные точки, на основе которых было построена сетка Делоне.
        /// </summary>
        public IPoint[] Points { get; private set; }
        /// <summary>
        /// A list of point indices that traverses the hull of the points.
        /// Список индексов точек, которые лнжат на границе выауклой области.
        /// </summary>
