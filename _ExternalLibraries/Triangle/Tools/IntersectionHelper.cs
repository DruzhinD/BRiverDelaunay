...
namespace TriangleNet.Tools
{
    ...
    public static class IntersectionHelper
    {
        ...
        /// Вычислить пересечение двух отрезков.
        /// </summary>
        ...
        /// Это частный случай пересечения отрезков. Поскольку вызывающий алгоритм гарантирует, 
        /// что действительное пересечение существует, 
        /// нет необходимости проверять какие-либо особые случаи.
        /// </remarks>
        ...
        /// Пересеките сегмент ограничивающей рамкой.
        /// </summary>
        ...
        /// На основе функции Лян-Барского Дэниела Уайта:
