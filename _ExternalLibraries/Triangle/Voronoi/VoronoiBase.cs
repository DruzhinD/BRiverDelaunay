...
namespace TriangleNet.Voronoi
{
    ...
    public abstract class VoronoiBase : DcelMesh
    {
        ...
        protected VoronoiBase(IMeshNet mesh, IVoronoiFactory factory, IPredicates predicates,
            bool generate)
            : base(false)
        {
        ...
        protected void Generate(IMeshNet mesh)
        {
            mesh.Renumber();
        ...
        protected List<HalfEdge>[] ComputeVertices(IMeshNet mesh, Vertex[] vertices)
        {
        ...
        protected void ComputeEdges(IMeshNet mesh, Vertex[] vertices, Face[] faces, List<HalfEdge>[] map)
        {
