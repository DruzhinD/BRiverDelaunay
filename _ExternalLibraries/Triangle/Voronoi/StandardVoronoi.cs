...
namespace TriangleNet.Voronoi
{
    ...
    {
        public StandardVoronoi(IMeshNet mesh)
            : this(mesh, mesh.bounds, new DefaultVoronoiFactory(), RobustPredicates.Default)
        {
        }

        public StandardVoronoi(IMeshNet mesh, Rectangle box)
            : this(mesh, box, new DefaultVoronoiFactory(), RobustPredicates.Default)
        {
        }

        public StandardVoronoi(IMeshNet mesh, Rectangle box, IVoronoiFactory factory, IPredicates predicates)
