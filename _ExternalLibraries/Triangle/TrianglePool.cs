...
namespace TriangleNet
{
    ...
    public class TrianglePool : ICollection<Triangle>
    {
        ...
        // Общее количество выделенных в данный момент треугольников.
        int size;
        ...
        public TrianglePool()
        {
            ...
            // При запуске пул должен вмещать 2 ^ 16 треугольников.
        ...
        public Triangle Get()
        {
            ...
            else
            {
                ...
                if (pool[block] == null)
                {
                    ...
                    // Проверьте, нужно ли изменять размер пула.
