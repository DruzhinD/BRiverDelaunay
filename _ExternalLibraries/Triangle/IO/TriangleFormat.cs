...
namespace TriangleNet.IO
{
    ...
    public class TriangleFormat : IPolygonFormat, IMeshFormat
    {
        ...
        public void Write(IMeshNet mesh, string filename)
        {
            ...
            writer.WritePoly((TriangleNet.IMeshNet)mesh, Path.ChangeExtension(filename, ".poly"));
            writer.WriteElements((TriangleNet.IMeshNet)mesh, Path.ChangeExtension(filename, ".ele"));
        }
