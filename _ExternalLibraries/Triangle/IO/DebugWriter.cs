...
namespace TriangleNet.IO
{
    ...
    class DebugWriter
    {
        ...
        /// </summary>
        public void Write(IMeshNet mesh, bool skip = false)
        {
        ...
        private void WriteMesh(IMeshNet mesh, bool skip)
        {
        ...
        private bool VerticesChanged(IMeshNet mesh)
        {
        ...
        private void HashVertices(IMeshNet mesh)
        {
            if (vertices == null || mesh.Vertices.Count != vertices.Length)
            {
