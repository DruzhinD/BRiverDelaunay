...
namespace TriangleNet.Topology
{
    ...
    public class Triangle : ITriangle
    {
        ...
        {
            return neighbors[index].tri.hash == IMeshNet.DUMMY ? null : neighbors[index].tri;
        }

        /// <inheritdoc />
        public int GetNeighborID(int index)
        {
            return neighbors[index].tri.hash == IMeshNet.DUMMY ? -1 : neighbors[index].tri.id;
        }
        ...
        {
            return subsegs[index].seg.hash == IMeshNet.DUMMY ? null : subsegs[index].seg;
        }
