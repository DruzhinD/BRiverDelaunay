...
namespace TriangleNet.Topology.DCEL
{
    ...
    public class DcelMesh
    {
        ...
        /// Инициализирует новый экземпляр класса <see cref = "DcelMesh" />.
        /// </summary>
        public DcelMesh()
            : this(true)
        {
        ...
        /// <резюме>
        /// Инициализирует новый экземпляр класса <see cref = "" />.
        /// </summary>
        /// <param name = "initialize"> Если false, списки не будут инициализированы. </param>
        ...
        /// Получает вершины диаграммы Вороного.
        /// </summary>
        ...
        /// Получает список полуребер, указывающих топологию диаграммы Вороного.
        /// </summary>
        ...
        /// Получает грани диаграммы Вороного.
        /// </summary>
        ...
        /// Получает набор ребер диаграммы Вороного.
        /// </summary>
        ...
        /// <returns></returns>
        /// <резюме>
        /// Проверяем, согласован ли DCEL.
        /// </summary>
        /// <param name = "closed"> Если true, предполагается, что грани замкнуты (т.е. все ребра должны иметь
        /// действительный следующий указатель). </param>
        /// <param name = "depth"> Максимальное количество граней граней (по умолчанию = 0 означает пропуск проверки). </param>
        /// <returns> </returns>
