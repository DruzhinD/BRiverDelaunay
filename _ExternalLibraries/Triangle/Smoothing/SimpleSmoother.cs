...
namespace TriangleNet.Smoothing
{
    ...
    public class SimpleSmoother : ISmoother
    {
        ...
        {
            var smoothedMesh = (TriangleNet.IMeshNet)mesh;
            ...
            for (int i = 0; i < limit; i++)
            {
                ...
                // of re-triangulating...
                smoothedMesh = (TriangleNet.IMeshNet)mesher.Triangulate(Rebuild(smoothedMesh), options);

                factory.Reset();
            }

            smoothedMesh.CopyTo((TriangleNet.IMeshNet)mesh);
        }

        private void Step(TriangleNet.IMeshNet mesh, IVoronoiFactory factory, IPredicates predicates)
        {
        ...
        /// Вычислить центр тяжести многоугольника.
        /// </summary>
        ...
        /// </summary>
        private Polygon Rebuild(TriangleNet.IMeshNet mesh)
        {
