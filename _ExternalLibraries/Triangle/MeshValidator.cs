...
namespace TriangleNet
{
    ...
    public static class MeshValidator
    {
        ...
        /// </summary>
        public static bool IsConsistent(IMeshNet mesh)
        {
            ...
            foreach (var t in mesh.triangles)
            {
                ...
                for (tri.orient = 0; tri.orient < 3; tri.orient++)
                {
                    ...
                    tri.Sym(ref oppotri);
                    if (oppotri.tri.id != IMeshNet.DUMMY)
                    {
        ...
        /// </summary>
        public static bool IsDelaunay(IMeshNet mesh)
        {
        ...
        /// </summary>
        public static bool IsConstrainedDelaunay(IMeshNet mesh)
        {
        ...
        /// </summary>
        private static bool IsDelaunay(IMeshNet mesh, bool constrained)
        {
            ...
            foreach (var tri in mesh.triangles)
            {
                ...
                for (loop.orient = 0; loop.orient < 3; loop.orient++)
                {
                    ...
                    shouldbedelaunay = (loop.tri.id < oppotri.tri.id) &&
                           !Otri.IsDead(oppotri.tri) && (oppotri.tri.id != IMeshNet.DUMMY) &&
                    ...
                    if (constrained && mesh.checksegments && shouldbedelaunay)
                    {
                        ...
                        if (opposubseg.seg.hash != IMeshNet.DUMMY)
                        {
