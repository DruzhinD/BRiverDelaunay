...
namespace TriangleNet.Geometry
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// <summary>
        /// Триангулирует многоугольник, применяя параметры качества.
        /// </summary>
        ...
        /// <резюме>
        /// Триангулирует многоугольник, применяя параметры качества и ограничения.
        /// </summary>
        /// <param name = "options"> Параметры ограничения. </param>
        /// <param name = "quality"> Параметры качества. </param>
        /// <param name = "triangulator"> Алгоритм триангуляции. </param>
        public static IMeshNet Triangulate(this IPolygon polygon, ConstraintOptions options, QualityOptions quality,
        ...
        /// <summary>
        /// Проверьте, лежит ли данная точка внутри треугольника или нет.
        /// </summary>
