...
namespace TriangleNet.Geometry
{
    ...
    /// Структура данных - вершина (узел).
    /// </summary>
    public class Vertex : Point
    {
        // Hash for dictionary. Will be set by mesh instance.
        // Хеш для словаря.Устанавливается экземпляром меша.
        public int hash;
        ...
        /// <param name="x">The x coordinate of the vertex.</param>
        /// <param name="y">The y coordinate of the vertex.</param>
        /// <param name="mark">Знак границы / The boundary mark.</param>
        ...
        /// Получает атрибуты вершины (можут быть нулевыми).
        /// </summary>
        public double[] Attributes
        {
        ...
        /// Получает указанные координаты вершины.
        /// </summary>
