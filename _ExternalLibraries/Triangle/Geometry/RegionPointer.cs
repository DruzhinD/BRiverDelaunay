...
namespace TriangleNet.Geometry
{
    ...
    /// <summary>
    /// Указатель на область в геометрии сетки. Область — это четко определенное 
    /// подмножество геометрии (заключенное в подсегменты).
    ...
    public class RegionPointer
    {
        ...
        /// <summary>
        /// Получает или задает ограничение области региона.
