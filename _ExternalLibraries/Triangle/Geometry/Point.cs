...
namespace TriangleNet.Geometry
{
    ...
    public class Point : IComparable<Point>, IEquatable<Point>
    {
        ...
        /// <summary>
        /// Получить или задать идентификатор вершины.
        /// </summary>
        public int ID
        {
            get { return this.id; }
        ...
        /// Получить или задать координату x вершины.
        /// </summary>
        public double X
        {
            get { return this.x; }
        ...
        /// <summary>
        /// Получить или задать координату y вершины.
        /// </summary>
        public double Y
        {
            get { return this.y; }
        ...
        /// Получает или задает метку общего назначения.
        /// </summary>
        /// <remarks>
        /// This is used for the vertex boundary mark.
        /// Это используется для отметки границы вершины.
        /// </remarks>
        public int Label
        {
