...
namespace TriangleNet
{
    ...
    class NewLocation
    {
        ...
        public NewLocation(IMeshNet mesh, IPredicates predicates)
        {
            this.mesh = mesh;
            ...
            ref double xi, ref double eta, bool offcenter, Otri badotri)
        {
            ...
            ///////////////// FINDING THE ORIENTATION OF GRADIENT_FILL_TRIANGLE //////////////////
        ...
        private int LongestShortestEdge(double aodist, double dadist, double dodist)
        {
            ...
            // HANDLE ISOSCELES GRADIENT_FILL_TRIANGLE CASE
            return minMidMax;
        }
                        ...
                        ref double[] thirdpoint, ref Otri neighotri)
        {
            ...
            for (badotri.orient = 0; badotri.orient < 3; badotri.orient++)
            {
                ...
                if (neighbor.tri.id != IMeshNet.DUMMY)
                {
            ...
            double x3, double y3, bool isObtuse)
        {
            ...
            /// HANDLE RIGHT GRADIENT_FILL_TRIANGLE CASE!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            return p;
