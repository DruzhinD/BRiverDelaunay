...
namespace TriangleNet.Meshing.Iterators
{
    ...
    public class RegionIterator
    {
        ...
        public RegionIterator(TriangleNet.IMeshNet mesh)
        {
        ...
        public void Process(Triangle triangle, Action<Triangle> action, int boundary = 0)
        {
            ...
            if (triangle.id == TriangleNet.IMeshNet.DUMMY || Otri.IsDead(triangle))
            {
                return;
            }
            ...
            if (boundary == 0)
            {
                ...
                ProcessRegion(action, seg => seg.hash == TriangleNet.IMeshNet.DUMMY);
            }
            else
            {
