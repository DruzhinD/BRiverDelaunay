...
namespace TriangleNet.Meshing.Algorithm
{
    ...
    public class Incremental : ITriangulator
    {
        ...
        {
            this.mesh = new TriangleNet.IMeshNet(config);
        ...
        int RemoveBox()
        {
            ...
            checkedge.Sym();
            if (checkedge.tri.id == TriangleNet.IMeshNet.DUMMY)
            {
            ...
            while (!nextedge.Equals(finaledge))
            {
                ...
                if (noPoly)
                {
                    ...
                    if (dissolveedge.tri.id != TriangleNet.IMeshNet.DUMMY)
                    {
                ...
                if (nextedge.tri.id == TriangleNet.IMeshNet.DUMMY)
                {
                    // Turn the corner.
