...
namespace TriangleNet.Meshing
{
    ...
    public static class Converter
    {
        ...
        /// </summary>
        public static TriangleNet.IMeshNet ToMesh(Polygon polygon, IList<ITriangle> triangles)
        {
        ...
        /// Reconstruct a triangulation from its raw data representation.
        /// </summary>
        public static TriangleNet.IMeshNet ToMesh(Polygon polygon, ITriangle[] triangles)
        {
            ...
            var mesh = new TriangleNet.IMeshNet(new Configuration());
        ...
        /// </summary>
        private static List<Otri>[] SetNeighbors(TriangleNet.IMeshNet mesh, ITriangle[] triangles)
        {
            Otri tri = default(Otri);
                ...
                for (tri.orient = 0; tri.orient < 3; tri.orient++)
                {
                    ...
                    if (checktri.tri.id != TriangleNet.IMeshNet.DUMMY)
                    {
                        ...
                        do
                        {
                            ...
                            checktri = nexttri;
                        } while (checktri.tri.id != TriangleNet.IMeshNet.DUMMY);
                    }
                }
        ...
        /// </summary>
        private static void SetSegments(TriangleNet.IMeshNet mesh, Polygon polygon, List<Otri>[] vertexarray)
        {
            Otri checktri = default(Otri);
            ...
            if (mesh.behavior.Poly)
            {
                ...
                foreach (var item in mesh.subsegs.Values)
                {
                    ...
                    for (subseg.orient = 0; subseg.orient < 2; subseg.orient++)
                    {
                        ...
                        while (notfound && (checktri.tri.id != TriangleNet.IMeshNet.DUMMY))
                        {
                            checkdest = checktri.Dest();
                            ...
                            if (tmp == checkdest)
                            {
                                ...
                                if (checkneighbor.tri.id == TriangleNet.IMeshNet.DUMMY)
                                {
        ...
        public static DcelMesh ToDCEL(TriangleNet.IMeshNet mesh)
        {
